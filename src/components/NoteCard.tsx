...
export default function NoteCard({ note, onArchive, onDelete }: NoteCardProps) {
  ...
  const CardContent = (
    <div className="bg-white dark:bg-gray-900 p-5 rounded-2xl shadow-sm dark:shadow-gray-800/50 border border-gray-100 dark:border-gray-800 transition-all duration-200 flex flex-col h-full hover:shadow-md dark:hover:shadow-gray-700 cursor-pointer group">
      <div className="flex justify-between items-start mb-2">
        <h4 className="text-base font-bold text-gray-900 dark:text-white line-clamp-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
          {note.title}
        </h4>
