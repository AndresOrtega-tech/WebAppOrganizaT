...
export default function LinkedItemsList({ items, type, onLinkNew }: LinkedItemsListProps) {
        ...
        {items.length === 0 ? (
          ...
          items.map((item) => (
            <Link
              ...
              className={`
                block p-3 rounded-lg shadow-sm transition-transform hover:-translate-y-0.5
                ${isTask 
