      ...
      <div className="bg-white rounded-3xl w-full max-w-sm shadow-xl p-6 animate-in fade-in zoom-in duration-200">
        ...
        {showDeleteConfirm ? (
          <div className="py-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
              >
                {isDeleting ? (
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <label htmlFor="tagName" className="block text-sm font-bold text-gray-700 mb-2">
                Nombre
              </label>
              <input
                id="tagName"
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl transition-all hover:shadow-lg hover:shadow-indigo-500/30 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
              ...
              {onDelete && (
                <button
                  ...
                  className="w-full text-red-600 hover:bg-red-50 font-semibold py-3 px-4 rounded-xl transition-colors flex items-center justify-center gap-2"
                >
